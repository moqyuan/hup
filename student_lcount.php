      ...
      <div class="modal-dialog">     
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">修改<?php echo $rs->No;?>号学员<?php echo $rs->Name;?>的课时：</h4>
          </div>
          <div class="modal-body">
            <form action="student_do.php?a=lcount" id="lcount" method="post" class="form-horizontal" role="form">
              
              <div class="form-group">
                <label class="col-sm-2 control-label">课时</label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="slcount" name="slcount" placeholder="课时数（必填）">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-warning" onClick="lcount.submit()">保存</button>
          </div>
        </div>
      </div>
      <br/>
